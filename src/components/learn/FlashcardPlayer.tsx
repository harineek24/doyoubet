  ...
  return (
    <div style={baseStyle}>
      ...
      >
        ...
        <span style={{ fontSize: 11, fontWeight: 600, color: accent, letterSpacing: "0.12em", textTransform: "uppercase" }}>
      ...
      {scene.type === "callout" && (
        <div style={{ marginTop: "clamp(1rem,3vh,2rem)", height: 2, width: 60, background: accent, borderRadius: 2 }} />
      )}
    </div>
  );
}

export function FlashcardLoadingScreen() {
  return (
    <div
      style={{
        minHeight: "100vh",
...
export function FlashcardErrorScreen({ message, onBack, backLabel = "Write new notes" }: { message: string; onBack: () => void; backLabel?: string }) {
  return (
    <div
      style={{
        minHeight: "100vh",
...
export function FlashcardPlayer({
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 13, color: P.textMuted, fontWeight: 500 }}>{title || "Your Notes"}</span>
        <span style={{ fontSize: 12, color: P.textDim, fontVariantNumeric: "tabular-nums" }}>
          {current + 1} / {scenes.length}
        </span>
      </div>

      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "rgba(255,255,255,0.05)", zIndex: 11 }}>
        <div
          style={{
            height: "100%",
          ...
          {scenes.map((scene, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: 3,
                border: "none",
                background: i === current ? SCENE_ACCENT[scene.type] : i < current ? "rgba(255,255,255,0.3)" : "rgba(255,255,255,0.1)",
                cursor: "pointer",
                padding: 0,
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          {isLast ? (
            <>
              ...
              <button
                onClick={(e) => { e.stopPropagation(); onExploreFull(); }}
                style={{
